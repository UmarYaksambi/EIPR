...
def extract_watermark(
    ...
    # BLIND GEOMETRIC CORRECTION:
    # We only need the attacked image because the sync tones are embedded within it!
    ...
    for tier_rate in unique_rates:
        ...
        for (br, bc) in tier_coords:
            ...
            for coeff_idx in EMBED_COEFF_INDICES:
                ...
                bit = _decode_coeff(float(coeffs[coeff_idx]), tier_alpha)
                votes[p, bit] += 1
                bit_idx += 1
